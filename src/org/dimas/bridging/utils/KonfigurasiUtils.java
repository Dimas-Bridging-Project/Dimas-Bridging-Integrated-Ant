...
public class KonfigurasiUtils {
    ...
    //Dapat berubah-ubah
    public String simpanKonfigurasi(String distCode, String distName, String recSls, String recStk, String recCln,
        ...
        String pesan = "OK";
         //1.1 Set Kode Distributor
            ...
            sysvar12.setIdSysvar("_DIST_NAME");
            sysvar12.setDeskripsi("Nama Distributor dari Principal");
            sysvar12.setTipeData("STR1");
            sysvar12.setNilaiString1(distName.toUpperCase().trim());
            sysvarDao.saveOrUpdate(sysvar12);
    ...
    public String setFirstKonfigurasiIfEmpty(){
        ...
        //1.1 Set Kode Distributor
            ...
            sysvar12.setDeskripsi("Nama Distributor dari Principal");
            sysvar12.setTipeData("STR1");
            sysvar12.setNilaiString1("CV. Dimas Kediri");
            sysvarDao.saveOrUpdate(sysvar12);
    ...
    public String setForceFirstKonfigurasi(){
        String pesan = "OK";
         //1.1 Set Kode Distributor
            ...
            Sysvar sysvar12 = new Sysvar();
            sysvar12.setIdSysvar("_DIST_NAMA");
            sysvar12.setDeskripsi("Nama Distributor dari Principal");
            sysvar12.setTipeData("STR1");
            sysvar12.setNilaiString1("CV. Dimas Kediri");
            sysvarDao.saveOrUpdate(sysvar12);
