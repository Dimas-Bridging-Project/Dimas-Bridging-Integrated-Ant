 ...
 * @author yhawin
 */
public class ExportSpEmployeeTarget {
    private static final Logger logger = LoggerFactory.getLogger(ExportSpEmployeeTarget.class);
    
//    ApplicationContext appContext;
//    SysvarDaoInter sysvarDao;

    public ExportSpEmployeeTarget() {
        initiates();
    }  
...
//            sysvarDao = (SysvarDaoInter) appContext.getBean("SysvarDaoBean");
    ...
    public List<OutputSpEmployeeTarget> exportFromListToFileExelUsingTemplate(String filePathDestination, List<SpEmployeeTarget> lst){
        List<OutputSpEmployeeTarget> list = new ArrayList<>();
        //FileWriter fileWriter = null;
        FileOutputStream out = null;
        logger.info("Starting export OutputSpEmployeeTarget");
        try {
...
//            String distName = sysvarDao.findById("_DIST_NAME").getNilaiString1();
            ...
            HSSFSheet sheet = workbook.createSheet("SpEmployeeTarget sheet");

            Map<Integer, Object[]> data = new HashMap<Integer, Object[]>();
            //CREATE HEADER
            data.put(1, new Object[] {"", "", "", "", ""});
            data.put(2, new Object[] {"","szYear", "szMonth", "szWorkplaceId", "intWorkingDay"});
            ...
            int lastRow= 2;
            for (SpEmployeeTarget spEmployeeTarget: lst) {
                lastRow++;
                data.put(lastRow, new Object[] {"","szYear", "szMonth", "szWorkplaceId", "intWorkingDay"});
...
//                
            ...
            workbook.write(out);
            System.out.println("OutputSpEmployeeTarget Excel written successfully..");            
    ...
    public List<OutputSpEmployeeTarget> exportFromListToFileExel(String filePathDestination, Date tglTransaksi, List<SpEmployeeTarget> lst){
        List<OutputSpEmployeeTarget> list = new ArrayList<>();
        //FileWriter fileWriter = null;
        FileOutputStream out = null;
        logger.info("Starting export OutputSpEmployeeTarget");
